  ...
  const SOCIALS = [
    {
      ...
      socialColor: '#FFF',
      path: links.facebook || 'https://discord.gg/2W7eum2Qfn',
    },
    {
      name: 'Instagram',
      icon: 'ant-design:instagram-filled',
      socialColor: '#FFF',
      path: links.instagram || 'https://www.instagram.com/hangryhipponft/',
    },
    {
      name: 'Twitter',
      icon: 'eva:twitter-fill',
      socialColor: '#FFF',
      path: links.twitter || 'https://twitter.com/hangryhipponft',
    },
  ];
